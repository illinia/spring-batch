...
public class ItemWriterAdapterJob {
    ...
    @Bean
    public ItemWriterAdapter<Customer> itemWriter(CustomService service) {
        ItemWriterAdapter<Customer> customerItemWriterAdapter = new ItemWriterAdapter<>();

        customerItemWriterAdapter.setTargetObject(service);
    ...
    public static void main(String[] args) {
        SpringApplication.run(ItemWriterAdapterJob.class, "customerFile=file:/Users/taemin/spring-batch/chapter09/src/main/resources/data/customer.csv","outputFile=file:/Users/taemin/spring-batch/chapter09/src/main/resources/output/formattedCustomers.txt");
    }
}
