...
import io.spring.batch.helloworld.batch.CustomerClassifier;
...
public class ClassifierCompositeItemWriterJob {
	...
	public ClassifierCompositeItemWriter<Customer> classifierCompositeItemWriter() throws Exception {
			Classifier<Customer, ItemWriter<? super Customer>> classifier = new CustomerClassifier(xmlDelegateItemWriter(null), jdbcDelegateItemWriter(null));
	...
	public static void main(String[] args) {
		SpringApplication.run(ClassifierCompositeItemWriterJob.class, "customerFile=file:/Users/taemin/spring-batch/chapter09/src/main/resources/data/customerWithEmail.csv", "outputFile=file:/Users/taemin/spring-batch/chapter09/src/main/resources/output/customer.xml");
	}
}
