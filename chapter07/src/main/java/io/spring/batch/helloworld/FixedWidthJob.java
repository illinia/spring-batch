...
public class FixedWidthJob {
    ...
    public static void main(String[] args) {
        List<String> strings = Arrays.asList("customerFile=file:///Users/gimtaemin/spring-batch/chapter07/src/main/resources/input/customerFixedWidth.txt");
        SpringApplication.run(FixedWidthJob.class, strings.toArray(new String[1]));
    }
}
