...
//        List<String> strings = Arrays.asList("customerFile=file:///Users/taemin/spring-batch/chapter07/src/main/resources/input/customerMultiFormat*");
//        SpringApplication.run(MultiFileJob.class, strings.toArray(new String[1]));
//    }
//}
