...
import io.spring.batch.helloworld.batch.CustomerFileReader;
import io.spring.batch.helloworld.batch.TransactionFieldSetMapper;
...
public class MultiLineJob {
    ...
    public static void main(String[] args) {
        List<String> strings = Arrays.asList("customerFile=file:///Users/gimtaemin/spring-batch/chapter07/src/main/resources/input/customerMultiFormat.csv");
        SpringApplication.run(MultiLineJob.class, strings.toArray(new String[1]));
    }
}
