...
public class CustomItemReader extends ItemStreamSupport implements ItemReader<Customer> {
    ...
    private Customer buildCustomer() {
        ...
        customer.setMiddleInitial(String.valueOf(middleInitial.charAt(
    ...
    public Customer read() {
        ...
        if(curIndex == 50) {
            throw new ParseException("This will end your execution");
        }
